                    ...
                    >
                        ...
                        <div className="ml-4 flex-grow overflow-hidden">
                            ...
                            <div className="mt-2 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
                                <div className="flex flex-nowrap whitespace-nowrap text-muted-foreground text-sm">
                                ...
                                <div className="flex items-center">
                                    {player.gameStats && player.gameStats.length > 0 ? (
                                                    ...
                                                    {[...player.gameStats].sort((a: GameStats, b: GameStats) => (a.week_number || 0) - (b.week_number || 0)).map((stat : GameStats, index: number) => {
                                                        ...
                                                        return (
                                                            <div key={stat.id} className="mr-2 flex-shrink-0 text-center">
                                                                <div className="bg-card px-2 py-1 rounded-md">
                                        ...
                                        <div className="text-muted-foreground text-sm mr-4">No games played</div>
                                    )}
